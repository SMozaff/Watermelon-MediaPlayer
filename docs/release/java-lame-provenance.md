...
| Clean-cache Dependency Integrity workflow passed before release candidate | [PR #14 clean-cache workflow](https://github.com/SMozaff/Watermelon-MediaPlayer/actions/runs/33134026843) passed at commit `525d39029e7893e6229dc8d86ef756867383d5d6`, including strict verification, the synthetic MP3 test, and SBOM generation. This is pre-candidate evidence only; re-run after the immutable candidate tag: ____________________ |
